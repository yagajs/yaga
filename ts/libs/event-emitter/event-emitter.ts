// Taken from: https://github.com/atd-schubert/typescript-event-emitter
/**
...
module com.atdSchubert.eventEmitter {
    'use strict';
    ...
    export class EventEmitter {
        ...
        private _events: IListenersList;
        private _onceReturnValue: boolean;
        ...
        public getListeners(evt?: string | RegExp): Function[] | any {
            var events: any = this._getEvents(),
                response: any,
                key: string,
                evtName: string = typeof evt === 'string' ? evt : undefined;
         ...
         */
        public flattenListeners(listeners: any[]): Function[] {
            var flatListeners: Function[] = [],
                i: number;
         ...
         */
        public getListenersAsObject(evt?: string| RegExp): any {
            var listeners: Function[] | any = this.getListeners(evt),
                response: any,
                evtName: string = typeof evt === 'string' ? evt : undefined;
         ...
         */
        public addListener(evt: string | RegExp, listenerOrFn: Function | IListener | any): EventEmitter {
            var listeners: IListenersList = this.getListenersAsObject(evt),
            // listenerIsWrapped: boolean = typeof listenerFn === 'object',
                listener: IListener = typeof listenerOrFn === 'object' ? listenerOrFn : {listener: listenerOrFn, once: false},
                listenerFn: Function = typeof listenerOrFn === 'function' ? listenerOrFn : listenerOrFn.listener,
                key: string;
         ...
         */
        public on(evt: string | RegExp, listener: Function): EventEmitter {
         ...
         * @return {Object} Current instance of EventEmitter for chaining.
         */
        public addOnceListener(evt: string | RegExp, listener: Function): EventEmitter {
         ...
         */
        public once(evt: string | RegExp, listener: Function): EventEmitter {
         ...
         * @return {Object} Current instance of EventEmitter for chaining.
         */
        public defineEvent(evt: string): EventEmitter {
         ...
         * @return {Object} Current instance of EventEmitter for chaining.
         */
        public defineEvents(evts: string[]): EventEmitter {
            for (let i: number = 0; i < evts.length; i += 1) {
         ...
         * @return {Object} Current instance of EventEmitter for chaining.
         */
        public removeListener(evt: string | RegExp, listenerOrFn: any | Function | IListener): EventEmitter {
            var listeners: IListenersList = this.getListenersAsObject(evt),
                index: number,
                key: string,
                listenerFn: Function = typeof listenerOrFn === 'function' ? listenerOrFn : listenerOrFn.listener;
         ...
         */
        public off(evt: string | RegExp, listenerOrFn: any | Function | IListener): EventEmitter {
         ...
         * @return {Object} Current instance of EventEmitter for chaining.
         */
        public addListeners(evt: any, listeners: any[]): EventEmitter {
         ...
         * @return {Object} Current instance of EventEmitter for chaining.
         */
        public removeListeners(evt: any, listeners: Function[]): EventEmitter {
            // Pass through to manipulateListeners
         ...
         * @return {Object} Current instance of EventEmitter for chaining.
         */
        public manipulateListeners(remove: boolean, evt: string | RegExp | any, listeners?: Function[]): EventEmitter {
            var hash: string,
                i: number,
                value: any,
                single: Function = remove ? this.removeListener : this.addListener,
                multiple: Function = remove ? this.removeListeners : this.addListeners;
         ...
         * @return {Object} Current instance of EventEmitter for chaining.
         */
        public removeEvent(evt: string | RegExp): EventEmitter {
            var type: string = typeof evt,
                events: IListenersList = this._getEvents(),
                key: string,
                evtName: string = typeof evt === 'string' ? evt : undefined;
         ...
         */
        public removeAllListeners(evt: string | RegExp): EventEmitter {
         ...
         * @return {Object} Current instance of EventEmitter for chaining.
         */
        public emitEvent(evt: string | RegExp, args: any[]): EventEmitter {
            var listenersMap: IListenersList = this.getListenersAsObject(evt),
                listeners: IListener[],
                listener: IListener,
                i: number,
                key: string,
         ...
         * Alias of emitEvent
         */
        public trigger(evt: string | RegExp, args: any[]): EventEmitter {
         ...
         * @return {Object} Current instance of EventEmitter for chaining.
         */
        public emit(evt: string | RegExp, ...args: any[]): EventEmitter {
            return this.emitEvent(evt, args);
        }
        /**
         ...
         * @return {Object} Current instance of EventEmitter for chaining.
         */
        public setOnceReturnValue(value: any): EventEmitter {
         ...
         * @api private
         */
        private _getOnceReturnValue(): boolean {
         ...
         * @api private
         */
        private _getEvents(): IListenersList {
         ...
         * @api private
         */
        private indexOfListener(listeners: IListener[], listener: Function): number {
